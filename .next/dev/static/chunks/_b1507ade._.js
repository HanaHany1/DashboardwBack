...
function LoginPage() {
    ...
    const [loadingBranches, setLoadingBranches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Fetch branches on component mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            const fetchBranches = {
                "LoginPage.useEffect.fetchBranches": async ()=>{
                    try {
                        const branchesData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getBranches();
                        console.log("[v0] Branches fetched:", branchesData);
                        // Map branches to credentials structure - adjust based on your backend response
                        const mappedBranches = branchesData.map({
                            "LoginPage.useEffect.fetchBranches.mappedBranches": (branch)=>({
                                    id: branch.id,
                                    name: branch.name,
                                    email: branch.email || `admin@${branch.name.toLowerCase().replace(/\s+/g, '')}`,
                                    password: branch.password || ""
                                })
                        }["LoginPage.useEffect.fetchBranches.mappedBranches"]);
            ...
            }["LoginPage.useEffect.fetchBranches"];
            fetchBranches();
        }
    }["LoginPage.useEffect"], []);
...
_s(LoginPage, "API6qvrbsmH9XsdedhHs+l2G4ks=", false, function() {
    return [
...
//# sourceMappingURL=_b1507ade._.js.map